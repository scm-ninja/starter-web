...
// forms.style.justifyContent = "space-between";
...
console.dir(hThree);
hThree[0].style.marginLeft = "1.2rem";
hThree[1].style.marginLeft = "1.2rem";
hThree[2].style.marginLeft = "1.2rem";
hThree[3].style.marginLeft = "1.2rem";
hThree[4].style.marginLeft = "1.2rem";
hThree[5].style.marginLeft = "1.2rem";
hThree[6].style.margin = "0 1.2rem 0 1.2rem";

let inputs = document.getElementsByTagName("input");
console.dir(inputs);
inputs[0].style.margin = "1.1rem .5rem 1.1rem 1.6rem";
inputs[0].style.height = "1.5rem";
inputs[0].style.width = "20rem";
inputs[1].style.margin = "1.1rem .5rem 1.1rem 4.6rem";
inputs[1].style.height = "1.5rem";
inputs[1].style.width = "20rem";
inputs[2].style.margin = "1.1rem .5rem 1.1rem 0.5rem";
inputs[2].style.height = "1.5rem";
inputs[2].style.width = "20rem";
inputs[3].style.margin = "1.1rem .5rem 1.1rem 0.6rem";
inputs[3].style.height = "1.5rem";
inputs[3].style.width = "20rem";
inputs[4].style.margin = "1.1rem .5rem 1.1rem 1.6rem";
inputs[4].style.height = "1.5rem";
inputs[4].style.width = "20rem";
inputs[5].style.margin = "1.1rem .5rem 1.1rem 2rem";
inputs[5].style.height = "1.5rem";
inputs[5].style.width = "20rem";
inputs[6].style.margin = "0 1.2rem 0 1.2rem";
inputs[7].style.margin = "0 1.2rem 0 1.2rem";
